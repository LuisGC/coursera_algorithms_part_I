 ...
 * @author luisgc
 */
public class WeightedQuickUnionPathCompression implements IQuickUnion {
     ...
     *            size
     */
    public WeightedQuickUnionPathCompression(final int size) {
        id = new int[size];
        sizes = new int[size];
    ...
    public static void main(final String[] args) {
        WeightedQuickUnionPathCompression qf =
                new WeightedQuickUnionPathCompression(DEFAULT_ARRAY_SIZE);
